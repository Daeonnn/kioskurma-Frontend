        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200 table-fixed">
            <thead class="bg-gray-50">
              <tr>
                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-20">ID</th>
                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Distributor</th>
                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-36">Telepon</th>
                <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-48">Alamat</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="item in distributors" :key="item.id" class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 w-20 text-center">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 w-36 text-center">
                  {{ item.phone }}
                </td>
                <td class="px-6 py-4 w-48 text-center">
                  <div class="text-sm text-gray-500 truncate" :title="item.address">{{ item.address }}</div>
                </td>
