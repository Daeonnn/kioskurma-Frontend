  ...
  <div class="p-6 bg-gray-50 min-h-screen">
    ...
    <nav class="mb-6">
      <ol class="flex text-gray-600 text-sm space-x-2">
        ...
        <li>/</li>
        <li class="text-indigo-600 font-semibold">Jenis</li>
      </ol>
    </nav>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
      <div class="flex justify-between items-center">
        <h2 class="text-2xl font-bold text-gray-800">Data Jenis</h2>
        <button 
        ...
        <div class="p-6">
          <div class="flex justify-between items-center mb-6">
            <h3 class="text-xl font-semibold text-gray-800">
              {{ isEditMode ? 'Ubah Jenis' : 'Tambah Jenis Baru' }}
            </h3>
          ...
          <form @submit.prevent="isEditMode ? updateJenis() : addJenis()">
            <div class="mb-6">
              <label for="namaJenis" class="block text-sm font-medium text-gray-700 mb-2">Nama Jenis</label>
              <input
                v-model="form.name"
                id="namaJenis"
                type="text"
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
      <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-semibold text-gray-800">Daftar Jenis</h3>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 table-fixed">
          <thead class="bg-gray-50">
            <tr>
              <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-24">ID</th>
              <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Jenis</th>
              <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-44">Aksi</th>
            </tr>
          </thead>
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="item in jenis" :key="item.id" class="hover:bg-gray-50 transition-colors">
      ...
      <!-- Empty State -->
      <div v-if="jenis.length === 0" class="text-center py-12 px-4">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada data jenis</h3>
        <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan jenis pertama Anda.</p>
      </div>
    </div>
  </div>
</template>
